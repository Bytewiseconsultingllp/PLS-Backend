...
const _1 = require(".");
exports.default = {
    CONSULTATIONPENDINGMESSAGEFROMADMIN: `Thank You for your interest in ${_1.COMPANY_NAME}. We have received your request for "free consultation". We are reviewing your request and will get back to you as soon as possible.<p>Best regards,</p> Prime Logic Solution`,
    ...
    ADMINNAME: ` administrator from ${_1.COMPANY_NAME}`,
    OTP_SENDER_MESSAGE: (OTP, expireyTime) => {
