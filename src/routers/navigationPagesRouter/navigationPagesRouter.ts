...
navigationPagesRouter
  ...
  .get(
    ...
    navigationPagesController.getSingleNavigationPage,
  );
...
navigationPagesRouter
  ...
  .put(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    navigationPagesController.updateNavigationPage,
  );
...
navigationPagesRouter
  ...
  .patch(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    navigationPagesController.trashNavigationPage,
  );
navigationPagesRouter
  ...
  .patch(
    ...
    navigationPagesController.untrashNavigationPage,
  );
