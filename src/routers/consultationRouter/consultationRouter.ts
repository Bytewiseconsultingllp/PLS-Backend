...
consultationRouter
  ...
  .get(
    ...
    consultationController.getAllRequestedConsultations,
  );
consultationRouter
  ...
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    consultationController.getSingleRequestedConsultation,
  );
consultationRouter
  ...
  .delete(
    ...
    consultationController.deleteRequestedConsultation,
  );
consultationRouter
  ...
  .patch(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    consultationController.acceptConsultationBooking,
  );
consultationRouter
  ...
  .patch(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    consultationController.rejectConsultationBooking,
  );
consultationRouter
  ...
  .patch(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    consultationController.trashConsultation,
  );
consultationRouter
  ...
  .patch(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIsAdmin,
    consultationController.untrashConsultation,
  );
