...
trashRouter
  ...
  .get(
    ...
    trashUserController.getTrashedUsers,
  );
trashRouter
  ...
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIsAdmin,
    trashMessages.getAllTrashedMessages,
  );
trashRouter
  ...
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIsAdmin,
    trashNavigationPagesController.trashedNavigationPages,
  );
trashRouter
  ...
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIsAdmin,
    trashGetQuotes.getTrashedQuotes,
  );
trashRouter
  ...
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIsAdmin,
    trashConsultations.getAllTrashedConsultations,
  );
...
trashRouter
  ...
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIsAdmin,
    trashHireUsController.getAllTrashedHireUs,
  );
trashRouter
  ...
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIsAdmin,
    trashContactUs.getTrashedContactUs,
  );
