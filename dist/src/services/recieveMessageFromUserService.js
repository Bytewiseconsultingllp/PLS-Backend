...
exports.recieveMessageFromUser = recieveMessageFromUser;
...
function recieveMessageFromUser(from, to, messageByUser, name) {
    return __awaiter(this, void 0, void 0, function* () {
        const templatePath = node_path_1.default.resolve(__dirname, "../templates/recieveMessageFromUser.html");
        let htmlTemplate = node_fs_1.default.readFileSync(templatePath, "utf8");
        htmlTemplate = htmlTemplate
            .replace("{{messageByUser}}", messageByUser)
            .replace("{{name}}", name)
            .replace("{{mail}}", from);
        ...
        try {
            ...
            loggerUtils_1.default.info("Message  recieveMessageFromUser: " + info.response);
        }
        catch (error) {
            if (error instanceof Error) {
                loggerUtils_1.default.error("message  recieving error:", error.message);
                throw {
