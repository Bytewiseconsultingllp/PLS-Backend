...
import {
  sendNewsLetterToAllUsersSchema,
  sendNewsLetterToSingleUserSchema,
  SubscribeORunsubscribeToNewsLetterSchema,
} from "../../validation/zod";
...
newsLetterRouter
  ...
  .post(
    validateDataMiddleware(SubscribeORunsubscribeToNewsLetterSchema),
    authMiddleware.checkToken,
    newsLetterController.subscribeToTheNewsLetter,
  );
...
newsLetterRouter
  ...
  .post(
    validateDataMiddleware(SubscribeORunsubscribeToNewsLetterSchema),
    authMiddleware.checkToken,
    newsLetterController.unsubscribedFromNewsLetter,
  );
newsLetterRouter
...
newsLetterRouter
  ...
  .get(
    ...
    newsLetterController.listAllSubscribedMails,
  );
