...
getQuoteRouter
  ...
  .post(getQuoteController.createServicesForQuote);
getQuoteRouter
  .route("/deleteServicesForQuote/:id")
  .delete(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    getQuoteController.deleteServicesForQuote,
  );
getQuoteRouter
  ...
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    getQuoteController.getSingleQuote,
  );
getQuoteRouter
  .route("/getAllQuotes")
  .get(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIAdminOrModerator,
    getQuoteController.getAllQuote,
  );
getQuoteRouter
  .route("/trashQuote/:id")
  .patch(
...
getQuoteRouter
  ...
  .patch(
    ...
    getQuoteController.unTrashQuote,
  );
getQuoteRouter
  ...
  .delete(
    authMiddleware.checkToken,
    authMiddleware.checkIfUserIsAdmin,
    getQuoteController.deleteQuote,
  );
